    ...
    <style>
        ...
        .bg-tentang-kami {
            background-image: 
                ...
                url('images/as.png'); /* Path to your image */
        ...
        /* Styling for the cta-container text */
        .cta-container h1 {
            font-size: 2rem;
            margin-left: 90px;
            color: white;
        ...
        /* Styling khusus untuk h2 (TIPS) */
        .cta-container h2.tips {
            font-size: 1.5rem; /* Ukuran font yang lebih kecil untuk h2 */
            font-weight: normal; /* Menghilangkan bold untuk TIPS */
            margin-left: 90px;
            color: white;
        }
    </style>
...
<body class="bg-gray-50">
    ...
    <header class="navbar py-0 bg-gradient-to-r from-[#46074E] to-[#197BD0] h-[80px] shadow-lg fixed w-full">
        <div class="container mx-auto flex items-center h-full px-5 sm:px-10 text-white font-bold">
            ...
            <nav class="hidden md:flex gap-5 text-sm ml-10">
                ...
                <a href="{{ url('/home') }}" class="hover:text-gray-200 transition-colors duration-300">Tentang Kami</a>
    ...
    <div class="bg-tentang-kami">
        <div class="cta-container">
            <h2 class="tips">TIPS</h2> <!-- Mengubah dari h1 ke h2 dengan kelas "tips" -->
...
<section id="artikel-terbaru" class="py-10 bg-white">
    <div class="container mx-auto px-4 sm:px-10">
        <h3 class="text-xl font-bold mb-8 text-left">ARTIKEL TERBARU</h3> <!-- Ubah ukuran dan posisikan ke kiri -->
        <div class="grid grid-cols-1 gap-0"> <!-- Menggunakan jarak antar elemen lebih besar -->
            <!-- Artikel 1 -->
            <div class="grid grid-cols-2 items-center bg-white rounded-lg overflow-hidden p-2"> <!-- Hapus shadow-lg -->
...
<div class="flex justify-center items-center mt-10 space-x-4">
    <button class="text-gray-500 hover:text-gray-700 text-xl">&larr;</button> <!-- Simbol panah kiri -->
    ...
    <button class="text-gray-500 hover:text-gray-700 text-xl">&rarr;</button> <!-- Simbol panah kanan -->
</div>
